    ...
    <div style={{
      ...
      <div style={{ background:C.card, padding:20 }}>
        <p style={{ fontFamily:'Inter,sans-serif', fontSize:14, color:C.t2, lineHeight:1.6, margin:'0 0 16px' }}>
          Brazil qualified as <strong style={{ color:C.t1 }}>Group A winners</strong>. Round of 16 moves to <strong style={{ color:C.t1 }}>Seattle on Jul 2</strong>. Chicago is no longer on your route.
        </p>
        <div style={{ display:'flex', gap:8 }}>
          <BtnPrimary label="Review new route" onClick={()=>{}} color={C.orange} style={{ flex:1, width:'auto' }}/>
